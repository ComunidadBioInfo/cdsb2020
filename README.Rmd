...
Descarga los materiales del curso usando `usethis::use_course('comunidadbioinfo/cdsb2020')` o revisa los materiales en línea usando [**comunidadbioinfo.github.io/cdsb2020**](http://comunidadbioinfo.github.io/cdsb2020).
...
1. Modificando los archivos de inicio de R
...
1. Debugging
1. Buenas prácticas de configuración y mantenimiento de espacios de trabajo
